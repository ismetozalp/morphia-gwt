...
public class Key<T> implements Serializable, Comparable<Key<?>> {
  ...
  /**
   * The name of the class which represents the kind. As much as we'd like to use the normal String
   * kind value here, translating back to a Class for getKind() would then require a link to the
